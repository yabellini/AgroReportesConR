...
Aquí cambiamos el subtítulo para concatenar palabras con el valor almacenado en `params$cultivar`, de esta manera podemos construir el subtítulo de forma progamática.
