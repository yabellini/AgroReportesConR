...
La función principal de ggplot2 se llama también `ggplot()`, y nos permite iniciar el gráfico y definir las características globales. El primer argumento de esta función serán los datos que queremos visualizar, siempre en un data.frame. En este caso utilizamos `cultivares`.
...
Necesitaremos 4 colores para los cuatro tipos de ensayo, usaremos `"darkorange"`, `"purple"` , `"cyan4"` y `"lightblue"` siguiendo las hermosas visualizaciones hechas por Allison Horst.
